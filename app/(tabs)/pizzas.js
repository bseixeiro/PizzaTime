...
export default function SettingsScreen() {
  ...
  useEffect( () => {
    setBas([
      { img: pep, name:"Pepperoni", composant:"je suis une pizza et mangez moi", price: "13.99", quantity: 0},
      { img: pep, name:"Pepperoni", composant:"je suis une pizza et mangez moi", price: "13.99", quantity: 0},
      { img: pep, name:"Pepperoni", composant:"je suis une pizza et mangez moi", price: "13.99", quantity: 0},
      { img: pep, name:"Pepperoni", composant:"je suis une pizza et mangez moi", price: "13.99", quantity: 0},
      { img: pep, name:"Pepperoni", composant:"je suis une pizza et mangez moi", price: "13.99", quantity: 0},
        ...
        return (
          <View style={styles.pizzaContainer} key={index}>
              ...
              <View style={styles.pizzaDesc}>
                ...
                <Text style={styles.pizzaContent}>{pizza.composant}</Text>
              </View>
          </TouchableOpacity>
